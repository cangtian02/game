 ...
 * 开始比牌动画
 */
var CompareStartTween = (function (_super) {
    __extends(CompareStartTween, _super);
    function CompareStartTween() {
        var _this = _super.call(this) || this;
        _this.viewBox = new egret.Sprite();
        _this.addEventListener(egret.Event.ADDED_TO_STAGE, _this.onAddToStage, _this);
        return _this;
    }
    CompareStartTween.prototype.onAddToStage = function () {
        // 初始化盒子
    ...
    return CompareStartTween;
}(egret.Sprite));
CompareStartTween.tweenTime = 700; // 动画总执行时间
__reflect(CompareStartTween.prototype, "CompareStartTween");
