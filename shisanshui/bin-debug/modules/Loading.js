...
var Loading = (function (_super) {
    ...
    Loading.prototype.createView = function () {
        ...
        if (!this.loadFlag) {
            ...
            var loading_bg_ap = new egret.Shape();
        ...
        // 绘制loading盒子
        var loadingView = new egret.Sprite();
        ...
        egret.setTimeout(function () {
            ...
            var loading_Factory = new egret.MovieClipDataFactory(loading_data, loading_png);
            var loading_move = new egret.MovieClip(loading_Factory.generateMovieClipData("loading_move"));
