 ...
 * 选择牌型右上角区域
 */
var ChooseRightTopView = (function () {
    function ChooseRightTopView() {
    ...
    ChooseRightTopView.prototype.createTitle = function () {
        for (var i = 0; i < 3; i++) {
            var t = '';
    ...
    return ChooseRightTopView;
}());
__reflect(ChooseRightTopView.prototype, "ChooseRightTopView");
// 推荐牌型列表
var ScrollerPosition = (function (_super) {
    ...
    ScrollerPosition.prototype.createChildren = function () {
        _super.prototype.createChildren.call(this);
        var recommend = ChooseView.recommend;
        var bg1 = RES.getRes('game_choose_list_json.list_bg_1');
        var bg2 = RES.getRes('game_choose_list_json.list_bg_2');
        var text = [
    ...
    // 列表点击事件
    ScrollerPosition.prototype.onChange = function (e) {
        // 整个开始第一次点击
        ...
        var recommend = ChooseView.recommend[this.list.selectedIndex].Cards;
        // 保存选中的牌型
...
ScrollerPosition.tapFlag = false; // 是否点击过
