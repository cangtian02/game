 ...
 * 小结算面板
 */
var GameRewardsPanel = (function () {
    function GameRewardsPanel() {
    ...
    GameRewardsPanel.prototype.createPanel = function () {
    ...
    GameRewardsPanel.prototype.createTop = function () {
        var vBox = new egret.Sprite();
    ...
    GameRewardsPanel.prototype.createList = function () {
    ...
    GameRewardsPanel.prototype.scrollList = function () {
        var data = GameRewards.data.rewards;
        var len = data.length;
        var vBox = new egret.Sprite();
        vBox.width = 1060;
        vBox.height = 110 * len;
        for (var i = 0; i < len; i++) {
            var list = new egret.Sprite();
            vBox.addChild(list);
            list.width = 1060;
            list.height = 110;
            list.y = i * 110;
    ...
    GameRewardsPanel.prototype.myKuang = function () {
        var vBox = new egret.Sprite();
        vBox.width = 1000;
        vBox.height = 110;
        vBox.x = 30;
    ...
    GameRewardsPanel.prototype.createNc = function (data) {
        var vBox = new egret.Sprite();
        vBox.width = 130;
        vBox.height = 100;
        vBox.y = 5;
    ...
    GameRewardsPanel.prototype.createDf = function (data) {
        var t = '';
        if (data.all_score < 0) {
    ...
    GameRewardsPanel.prototype.createPoker = function (data) {
        var vBox = new egret.Sprite();
        vBox.width = 755;
        vBox.height = 110;
        vBox.x = 229;
        var stCards = data.stCards.reverse();
        for (var i = 0, len = stCards.length; i < len; i++) {
    ...
    return GameRewardsPanel;
}());
__reflect(GameRewardsPanel.prototype, "GameRewardsPanel");
